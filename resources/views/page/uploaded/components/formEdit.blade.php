...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary rounded p-4">
        ...
        <form action="../uploaded/update_upload/{{$user->id}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label text-start">Tim Produksi</label>
                <div class="col-sm-10">
                    <select class="selectpicker w-100" multiple data-live-search="true" name="produksi[]">                            
            ...
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label text-start">Nama Produksi</label>
                <div class="col-sm-10">
                    <select  class="selectpicker w-100" multiple data-live-search="true" name="name[]">                            
                        @foreach ($use as $data)
            ...
            <div class="d-grid justify-content-md-end">
                <button type="submit" class="btn btn-primary px-5"><i class="bi bi-pencil-square me-2"></i>Update</button>
            </div>
        </form>
    </div>
